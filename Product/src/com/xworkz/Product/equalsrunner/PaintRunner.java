...
public class PaintRunner {
	...
	public static void main(String[] args) {
		Paint paint = new Paint("Apex Ultima", 1.00, "Saffron", "Asiaan", 500, true, true, "Best", "Oilpaint",
				"Banglore");
		Paint paint1 = new Paint("Emporia", 2.00, "White", "Asiaan", 500, true, true, "Best", "Oilpaint", "Banglore");
