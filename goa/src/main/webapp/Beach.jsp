	...
	<form action="show" method="post">
		<div class="mb-3">
			...
			<input type="text" class="form-control" name="name"
				...
				<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">location</label> <input type="text" class="form-control"
		...
		<div class="mb-3">
			<label for="exampleFormControlInput1" class="form-label">games</label> <input type="text" class="form-control"
