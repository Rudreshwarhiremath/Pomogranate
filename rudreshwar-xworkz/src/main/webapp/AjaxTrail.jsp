...
<!-- 	<div id="demo">
		...
		<button type="button"
			onclick="loadDoc('http://localhost:8088/rudreshwar-xworkz/dto', myFunction)">Change
			Content</button>
	</div> -->
	...
	/*	function loadDoc(url, xFunction) {
		...
		function myFunction(xhttp) {
		 ...
		 const xhttp = new XMLHttpRequest();
		 var id = document.getElementById("highwayId").value=this.responseText;
		 xhttp.open("GET", "http://localhost:8088/rudreshwar-xworkz/dto");
		 xhttp.send();
		 xhttp.onload = function() {
		 console.log(this);
