...
<body>
	...
	<form action="update" method="post">
		...
		Highway Name<input type="text" name="name" value="${dto.name}"
			readonly><br> Highway Starts<input type="text"
			name="source" value="${dto.source}"><br> Highway Reaches<input
			type="text" name="destination" value="${dto.destination}"><br>
		Highway Kilo Miter<input type="text" name="kiloMiter"
			value="${dto.kiloMiter}"><br> Type<select name="type">
